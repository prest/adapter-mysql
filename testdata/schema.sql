...
CREATE TABLE test3(id serial, name VARCHAR(255), UNIQUE KEY unique_name(name));
CREATE TABLE test4(id serial primary key, name VARCHAR(255), UNIQUE KEY unique_name(name));
...
INSERT INTO test_multiple_fields(created_at) VALUES ('1997-12-17 07:37:16');
